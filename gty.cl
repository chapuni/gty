...
T cmps(T a, T b)
{
	return (0
			...
			|| cmp8(a, b, '/','/','H','A','G','E','/','/')
			|| cmp8(a, b, 'M','o','k','u','t','o','n','.')
			|| cmp8(a, b, 'D','I','E','.','.','.','.','.')
			|| cmp8(a, b, 'H','R','.','R','y','a','l','.')
			|| cmp8(a, b, 'H','R','.','R','y','a','l','/')
			|| cmp8(a, b, 'H','R','/','R','y','a','l','.')
			|| cmp8(a, b, 'H','R','/','R','y','a','l','/')
			|| cmp8(a, b, 'M','O','O','N','L','I','N','E')
			|| cmp8(a, b, 'N','E','X','T','A','G','E','/')
			|| cmp8(a, b, 'M','r','r','U','k','Q','3','y')
			|| cmp8(a, b, 'A','I','R','C','H','A','I','R')
			|| cmp8(a, b, 'R','E','S','T','A','R','T','.')
			|| cmp8(a, b, 'R','E','S','T','A','R','T','/')
			|| cmp8(a, b, '5','9','6','3','.','.','.','.')
			|| cmp8(a, b, 'O','.','O','.','.','.','.','O')
			);
